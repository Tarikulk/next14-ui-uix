    ...
    return (
        <div className="pt-4 lg:pt-10">
            <div className="px-[20px] lg:px-[280px]">
                ...
                <div className="flex w-full pt-8 justify-center gap-x-6">
                    ...
                    <button className="w-1/2 text-[#4328EB] flex items-center justify-center gap-x-2 lg:w-fit">View Pricing <Image src={BlueArrow} alt="Blue Arrow" /> </button>
                </div>
        ...
        <div className="relative flex h-full justify-center">
            ...
            <div className="absolute bottom-5 flex w-full flex-col items-center">
                <Image src={HeroImage} alt="Hero Image" className="-ml-8 h-[310px] sm:-mb-20 sm:h-[400px] lg:-mb-28 lg:h-auto xl:w-[70%]" />
