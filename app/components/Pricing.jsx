...
export function Pricing(){
    return(
        <div className="py-[48px] lg:py-[60px]">
            ...
            <p className="pt-[16] pb-[40px] text-center text-[#36485C] text-[18px]">No hidden fees!</p>
            ...
            <div className="flex flex-col gap-y-6 gap-x-[24px] lg:flex-row">
                ...
                <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
                    <div>
                        ...
                        <ul className="flex flex-col gap-y-2 pt-4 text-[#36485C]">
                            <li className="flex items-center gap-x-2"><span><Image src={Check} alt="Check" /> </span> Lorem ipsum dolor sit amet</li>
                            <li className="flex items-center gap-x-2"><span><Image src={Check} alt="Check" /> </span> Lorem ipsum dolor sit amet</li>
                            <li className="flex items-center gap-x-2"><span><Image src={Check} alt="Check" /> </span> Lorem ipsum dolor sit amet</li>
                        </ul>
                    </div>
                ...
                <div className="w-full rounded-[8px] bg-[#4328EB] p-6 flex flex-col lg:justify-between">
                    <div>
                        ...
                        <h2 className="pt-4 text-2xl text-white font-medium lg:text-[32px]">$500<span className="text-white">/mo</span></h2>
